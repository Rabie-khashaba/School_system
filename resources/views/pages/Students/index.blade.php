                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item" href="{{route('Payment_students.show',$student->id)}}"><i style="color: #9dc562" class="fas fa-money-bill-alt"></i>&nbsp; &nbsp; سند صرف</a>
                                                            ...
                                                            <a class="dropdown-item" data-target="#Graduate_Student{{ $student->id }}" data-toggle="modal" href="##Graduate_Student{{ $student->id }}"><i style="color: red" class="fa fa-eye"></i>&nbsp; تخرج الطالب</a>
